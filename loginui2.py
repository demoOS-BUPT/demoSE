...
class login(QtGui.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        #self.setWindowIcon(QtGui.QIcon("logins.jpg"))
        ...
        self.trayIcon.setIcon(QtGui.QIcon("images/logins.jpg"))
        ...
        #self.label.setPixmap(QtGui.QPixmap("images/logins.jpg"))
        ...
        self.pushButton_login = QtGui.QPushButton(QtGui.QIcon("images/logins.jpg"), u"登录", self)

        self.pushButton_login.setGeometry(QtCore.QRect(250, 235, 75, 22))

        self.pushButton_change = QtGui.QPushButton(QtGui.QIcon("images/logins.jpg"), u"身份切换", self)
    ...
    def contextMenu(self):
        ...
        self.userOption = QtGui.QAction(QtGui.QIcon("images/logins.jpg"), u"学生", self)

        self.rootOption = QtGui.QAction(QtGui.QIcon("images/logins.jpg"), u"老师", self)
    ...
    def btnEnter(self, ID):
        ...
        if ID == 1:
            ...
            self.btn_min.setPixmap(QtGui.QPixmap("images/logins.jpg"))

        elif ID == 2:

            self.btn_close.setPixmap(QtGui.QPixmap("images/logins.jpg"))
    ...
    def trayMenu(self):
        ...
        img_main = QtGui.QIcon("images/logins.jpg")

        img_exit = QtGui.QIcon("images/logins.jpg")
