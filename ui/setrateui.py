...
""))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 570, 311, 221))
        self.tabWidget.setStyleSheet(_fromUtf8("background-color: rgb(239, 247, 247);"))
        self.tabWidget.setObjectName(_fromUtf8("tabWidget"))
        self.windTab = QtGui.QWidget()
        self.windTab.setObjectName(_fromUtf8("windTab"))
        self.highRateEdit = QtGui.QLineEdit(self.windTab)
        self.highRateEdit.setGeometry(QtCore.QRect(100, 120, 171, 31))
        self.highRateEdit.setObjectName(_fromUtf8("highRateEdit"))
        self.label = QtGui.QLabel(self.windTab)
        self.label.setGeometry(QtCore.QRect(40, 40, 41, 31))
        self.label.setObjectName(_fromUtf8("label"))
        self.lowRateEdit = QtGui.QLineEdit(self.windTab)
        self.lowRateEdit.setGeometry(QtCore.QRect(100, 40, 171, 31))
        self.lowRateEdit.setObjectName(_fromUtf8("lowRateEdit"))
        self.midRateEdit = QtGui.QLineEdit(self.windTab)
        self.midRateEdit.setGeometry(QtCore.QRect(100, 80, 171, 31))
        self.midRateEdit.setObjectName(_fromUtf8("midRateEdit"))
        self.label_3 = QtGui.QLabel(self.windTab)
        self.label_3.setGeometry(QtCore.QRect(40, 120, 51, 31))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_2 = QtGui.QLabel(self.windTab)
        self.label_2.setGeometry(QtCore.QRect(40, 80, 51, 31))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.tabWidget.addTab(self.windTab, _fromUtf8(""))
        self.elecTab = QtGui.QWidget()
        self.elecTab.setObjectName(_fromUtf8("elecTab"))
        self.perMoneyEdit = QtGui.QLineEdit(self.elecTab)
        self.perMoneyEdit.setGeometry(QtCore.QRect(131, 71, 171, 21))
        self.perMoneyEdit.setObjectName(_fromUtf8("perMoneyEdit"))
        self.label_4 = QtGui.QLabel(self.elecTab)
        self.label_4.setGeometry(QtCore.QRect(41, 71, 83, 16))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.perTempEdit = QtGui.QLineEdit(self.elecTab)
        self.perTempEdit.setGeometry(QtCore.QRect(131, 101, 171, 21))
        self.perTempEdit.setObjectName(_fromUtf8("perTempEdit"))
        self.label_5 = QtGui.QLabel(self.elecTab)
        self.label_5.setGeometry(QtCore.QRect(11, 101, 113, 16))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.tabWidget.addTab(self.elecTab, _fromUtf8(""))
...
""))
    ...
    def retranslateUi(self, Form):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.windTab), _translate("Form", "单位时间耗电量", None))
        self.label_4.setText(_translate("Form", "金额/度电：", None))
        self.label_5.setText(_translate("Form", "温度变化/度电：", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.elecTab), _translate("Form", "设置电率", None))
