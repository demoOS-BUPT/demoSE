...
"selection-background-color: rgb(109, 94, 89);"))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 320, 681, 81))
...
"color: rgb(109, 94, 89);"))
        ...
        self.weekBtn = QtGui.QRadioButton(Form)
        self.weekBtn.setGeometry(QtCore.QRect(31, 185, 72, 19))
        self.weekBtn.setStyleSheet(_fromUtf8("color: rgb(240, 211, 177);"))
        self.weekBtn.setObjectName(_fromUtf8("monthBtn"))
        self.monthBtn = QtGui.QRadioButton(Form)
        self.monthBtn.setGeometry(QtCore.QRect(31, 225, 72, 19))
...
"}"))
        ...
        self.title.setGeometry(QtCore.QRect(20, 280, 311, 31))
        self.title.setStyleSheet(_fromUtf8("color: rgb(240, 211, 177);"))
    ...
    def retranslateUi(self, Form):
        ...
        self.weekBtn.setText(_translate("Form", "周报表", None))
        self.monthBtn.setText(_translate("Form", "月报表", None))
